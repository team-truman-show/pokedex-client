...
const CustomModal = ({ isOpen, onClose, title, message, isError, imageSrc }) => {
  return (
    <Modal open={isOpen} onClose={onClose} aria-labelledby="custom-modal-title" aria-describedby="custom-modal-description">
      <Box
        sx={{
          position: "absolute",
          top: "50%",
